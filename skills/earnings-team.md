# 财报精读团队：13 席大师并行解读 + 公众号发布

对 $ARGUMENTS 进行团队化财报精读分析。**默认 13 席大师并行**（4 核心深读 + 9 国际唱反调，见 CLAUDE.md「投资大师阵容」）解读财报，编辑润色成文，读者评审把关质量，最终产出可直接发布的公众号文章。**不得默认只用四大师**——若因篇幅收缩须显式标注取舍。
...
本 Skill 的流程分三阶段：
- **阶段一·研究**：13 席并行精读财报——**核心 4 席深读**（段永平看生意本质、巴菲特审财务质量、芒格读竞争变化、李录猎风险信号）+ **国际 9 席唱反调**（马克斯周期/达利欧宏观/费雪一手调研/林奇GARP/卡拉曼下行/格雷厄姆便宜/帕伯莱赔率/博格成本/塔勒布尾部；lens 见 `skills/master-lens.md`）
- **阶段二·合成**：Team Lead 综合 13 视角、开"大师异见庭"（分歧不抹平），产出研究报告初稿
- **阶段三·发布**：编辑 Agent 改写为公众号文章 + 读者评审 Agent 提出修改意见 → Team Lead 定稿

> 国际 9 席默认全开，各以其大师镜头对财报"唱反调"（周期位置/宏观相关/一手验证/GARP/下行/深度便宜/非对称赔率/机会成本/尾部生存）。若财报篇幅所限收缩，最少保留 4 核心 + 按标的智能选 2–4 国际，并在文中标注取舍。

---

## 阶段一：13 席大师并行研究（4 核心 + 9 国际）
...
| 研究 | 国际异见庭（9 席） | 马克斯/达利欧/费雪/林奇/卡拉曼/格雷厄姆/帕伯莱/博格/塔勒布 | 周期/宏观/一手/GARP/下行/便宜/赔率/成本/尾部——唱反调 |
| 发布 | 编辑 | 公众号写作 | 把研究报告改写成好文章 |
| 发布 | 读者评审 | 普通投资者 | 读者能看懂吗？有收获吗？ |

### 第三步：启动并行研究 Agent（默认 13：4 核心详版 + 9 国际异见）

使用 Agent 工具在**同一条消息**中并行启动：**核心 4 席**（下方 Agent 1–4 详版）+ **国际 9 席**（马克斯/达利欧/费雪/林奇/卡拉曼/格雷厄姆/帕伯莱/博格/塔勒布，各以其 `master-lens` 镜头对财报唱反调：周期/宏观/一手调研/GARP/下行/深度便宜/非对称赔率/成本机会/尾部生存）。不得默认只启 4 个——收缩须在报告标注取舍。
...
1. **共识点**：13 席（4 核心 + 9 国际）都同意的结论，可信度最高；分歧点单列（大师异见庭，不抹平）
...
3. **表达润色**
   ...
   - 大师点评语录是文章的灵魂（默认从 13 席按相关性选，不默认只用四大师）——确保每条都犀利、有记忆点
   - 段落不超过4行，句子不超过30字
   - 适度使用对比和反差制造阅读节奏
...
├── {公司名}-earnings-{期间}-研究底稿.md   ← 13 席合成研究报告（4 核心+9 国际，自用）
