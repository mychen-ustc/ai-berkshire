---
name: pipeline
description: "AI Berkshire skill: 三级机会流水线. Source: skills/pipeline.md."
---

## Codex adapter note

This skill is generated from `skills/pipeline.md` so Claude Code and Codex users share one canonical workflow.
