...
description: "AI Berkshire skill: 统一 Watchlist 状态机. Source: skills/watchlist-pipeline.md."
---

## Codex adapter note

This skill is generated from `skills/watchlist-pipeline.md` so Claude Code and Codex users share one canonical workflow.
