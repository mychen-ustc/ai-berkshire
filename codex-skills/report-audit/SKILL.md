---
name: report-audit
description: "AI Berkshire skill: 报告审计：AI 硬门禁 + 数据抽检. Source: skills/report-audit.md."
---

## Codex adapter note

This skill is generated from `skills/report-audit.md` so Claude Code and Codex users share one canonical workflow.
