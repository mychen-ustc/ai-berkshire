...
description: "AI Berkshire skill: 业绩归因：收益到底从哪来. Source: skills/performance-attribution.md."
---

## Codex adapter note

This skill is generated from `skills/performance-attribution.md` so Claude Code and Codex users share one canonical workflow.
