...
description: "AI Berkshire skill: 资产配置 SAA/TAA. Source: skills/asset-allocation.md."
---

## Codex adapter note

This skill is generated from `skills/asset-allocation.md` so Claude Code and Codex users share one canonical workflow.
