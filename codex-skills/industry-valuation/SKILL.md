...
description: "AI Berkshire skill: 行业专用估值模型. Source: skills/industry-valuation.md."
---

## Codex adapter note

This skill is generated from `skills/industry-valuation.md` so Claude Code and Codex users share one canonical workflow.
