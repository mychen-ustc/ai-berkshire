...
description: "AI Berkshire skill: 标的主数据 + 点时快照库（事实源）. Source: skills/security-master.md."
---

## Codex adapter note

This skill is generated from `skills/security-master.md` so Claude Code and Codex users share one canonical workflow.
